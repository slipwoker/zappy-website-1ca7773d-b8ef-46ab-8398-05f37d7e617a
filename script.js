    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      for (let i = 0; i < formElements.length; i++) {
        ...
        if (field.hasAttribute('required') && !field.value.trim()) {
          ...
          isValid = false;
          field.classList.add('error');
          showError(field, 'Minimum length is ' + field.getAttribute('minlength') + ' characters');
        }
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "כבש הכבשים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '1ca7773d-b8ef-46ab-8398-05f37d7e617a',
                    name: data.name || '',
                    email: data.email || '',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1ca7773d-b8ef-46ab-8398-05f37d7e617a';
